...
function Portfolio() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "A secure mobile banking application with biometric authentication, transaction history, and modern UI/UX design principles.",
    ...
    },
    {
      ...
      description: "An intelligent analytics dashboard with machine learning insights, data visualization, and predictive analytics capabilities.",
    ...
    },
    {
      ...
      description: "A secure cryptocurrency wallet with multi-currency support, transaction tracking, and portfolio management features.",
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 py-20 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-8">
            Discover my latest projects and creative solutions. Each project represents a unique challenge solved with modern technologies.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <button className="px-6 py-3 bg-red-400 hover:bg-red-500 text-white rounded-lg font-medium transition-colors">
              View All Projects
            </button>
            <button className="px-6 py-3 bg-transparent border border-gray-400 hover:border-red-400 text-white rounded-lg font-medium transition-colors">
              Filter by Category
            </button>
          </div>
        </div>
